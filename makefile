...
main.o: main.c cutpaste.h filehandle.h statdisplay.h writesave.h cursor.h
	@gcc -c main.c cutpaste.h filehandle.h statdisplay.h writesave.h cursor.h -lncurses -lm -Wall
