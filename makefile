...
compile femto: main.o cutpaste.o filebuffer.o statdisplay.o writesave.o cursor.o execprint.o
	@gcc -o femto main.o cutpaste.o filebuffer.o statdisplay.o writesave.o cursor.o execprint.o -lncurses -lm -Wall
run: femto
	@./femto $(ARGS)
clean:
	rm -f *.o *.h.gch femto

main.o: main.c cutpaste.h filebuffer.h statdisplay.h writesave.h cursor.h execprint.h
	@gcc -c main.c cutpaste.h filebuffer.h statdisplay.h writesave.h cursor.h execprint.h -lncurses -lm -Wall
